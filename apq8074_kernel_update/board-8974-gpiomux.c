...
/* [SIMG] begin, starter kit gpio configs */
static struct gpiomux_setting gpio_mhl_reset_config = {
...
static struct gpiomux_setting gpio_mhl_intrrupt_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_IN,
};
static struct gpiomux_setting gpio_stark_usb0_config = {
  	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_LOW,
...
static struct gpiomux_setting gpio_stark_usb1_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_LOW,
...
static struct gpiomux_setting gpio_stark_vbus_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_LOW,
...
//		},
//	},
	/* [SIMG] begin,used 85 pin for different purpose on starter kit*/
/*	{
		.gpio      = 85,		// EPM MARKER2
		.settings = {
...
/* [SIMG] begin, add pin mux settings for BLSP3 & BLSP8 */
	{
		.gpio      = 8,			/* BLSP3_3 starter kit reset gpio */
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_mhl_reset_config,
			[GPIOMUX_SUSPENDED] = &gpio_suspend_config[0],
		},
	},
	{
	   	.gpio 	 = 64,/* SENSOR_RESET_N starter kit USB0 select line */
	   	.settings = {
	   		[GPIOMUX_ACTIVE] = &gpio_stark_usb0_config,
			[GPIOMUX_SUSPENDED] = &gpio_stark_usb0_config,
		},

	},
	{
	   	.gpio    = 78,/* SNS_TEST1 starter kit USB1 select line */
	   	.settings = {
			[GPIOMUX_ACTIVE] = &gpio_stark_usb1_config,
			[GPIOMUX_SUSPENDED] = &gpio_stark_usb1_config,
	   	},

	},
	{
	   	.gpio    = 85,/* BLSP12_3 starter kit VBUS control line */
	   	.settings = {
			[GPIOMUX_ACTIVE] = &gpio_stark_vbus_config,
			[GPIOMUX_SUSPENDED] = &gpio_stark_vbus_config,
	   	},

	},

	{
		.gpio      = 7,			/* BLSP3_2 starter kit interrupt gpio */
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_mhl_intrrupt_config,
			[GPIOMUX_SUSPENDED] = &gpio_suspend_config[0],
		},
	},
	{
		.gpio      = 10,			/* BLSP3 I2C_SDA */
		.settings = {
...
//APQ8074 SPI SUPPORT START
/*static struct msm_gpiomux_config apq8074_dragonboard_blsp12_spi_config[] __initdata = {
  {
  /? BLSP12 QUP SPI MOSI 
  .gpio      = 85,
  .settings = {
...
//APQ8074 SPI SUPPORT END
static struct msm_gpiomux_config apq8074_dragonboard_blsp8_spi_config[] __initdata = {
	{
		.gpio = 48,
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_spi_config,
...
//			ARRAY_SIZE(apq8074_dragonboard_ts_config));
	...
	if (of_board_is_dragonboard() && machine_is_apq8074()) {
		msm_gpiomux_install(apq8074_dragonboard_ts_config, 
			ARRAY_SIZE(apq8074_dragonboard_ts_config));
		//msm_gpiomux_install(apq8074_dragonboard_blsp12_spi_config,
		//	ARRAY_SIZE(apq8074_dragonboard_blsp12_spi_config));
		//msm_gpiomux_install(apq8074_dragonboard_blsp8_spi_config,
		//	ARRAY_SIZE(apq8074_dragonboard_blsp8_spi_config));			
	}
//APQ8074 SPI SUPPORT END
